...
const styles = StyleSheet.create({
    ...
    nonOwnerNotice: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 16, backgroundColor: '#f8fafc', borderTopWidth: 1, borderTopColor: '#e5eaf0' },
